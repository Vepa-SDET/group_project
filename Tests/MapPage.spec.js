...
var HuntPage= require('../Pages/Hunt.page.js');
var Base = require('../Utilities/Base.js');
var Data = require('../TestData/data.json');
var MySelfPage=require('../Pages/mySelf.page.js');

var MapPage = require('../Pages/Map.page.js');
var RoomsPage = require('../Pages/Rooms.page.js');
var MapData = require('../TestData/MapPage.json');
...
describe('BookIT Map Page test scripts', () => {
    ...
    it('039-> should verify if "meru" link directs to the correct page', () => {
        ...
        expect(RoomsPage.roomsPageScheduvarable.isDisplayed()).toBe(true);
